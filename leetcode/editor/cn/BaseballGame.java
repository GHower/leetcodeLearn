        ...
        public int calPoints(String[] ops) {
            ...
            for (String op : ops) {
                if( "C".equals(op)){
                    ...
                    stack.offerLast(integer * 2);
                }else if("+".equals(op)){
                    Integer last = stack.pollLast();
//                    stack.removeLast();
                    Integer lastPre = stack.getLast();
                    stack.offerLast(last);
                    stack.offerLast(last + lastPre);
                }else{
                    stack.offerLast(Integer.parseInt(op));
                }
...
//
//            }
            int sum = stack.stream().mapToInt(e -> e).sum();
